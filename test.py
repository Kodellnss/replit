...
print("Hello World"[:5])
print("Hello World"[5:])
parcelle_id = "31555821AB0509"
print(parcelle_id[8:10])
print(parcelle_id[-6:-4])
print("BENJAMIN".islower())
print("BENJAMIN".lower())
print("Sarkozy Hollande Sarkozy".find("Sarkozy"))
print("Sarkozy Hollande Sarkozy".count("Sarkozy"))
print("Sarkozy Hollande Sarkozy".find("Hollande"))
print("drilling_speed_miles_per_day".replace("miles", "meters"))
...
print(jour_mois_annee)
type(jour_mois_annee)
...
movies = ["Titanic", "Django", ["Seigneur des anneaux 1","Seigneur des anneaux 2","Seigneur des anneaux 3"]]
print(movies)

s_a = ["Seigneur des anneaux 1","Seigneur des anneaux 2","Seigneur des anneaux 3"]

movies = ["Titanic", "Django", s_a]
print(movies)
...
shopping = ["tomatoes", "carrots", "bananas"]
shopping.sort()
print(shopping)
...
warehouse_stocks["tomatoes"]
print(warehouse_stocks["tomatoes"])
...
spec = machine_two["specifications"]
depth_capacity_miles = spec["depth_capacity_miles"]

depth_capacity_miles_km = depth_capacity_miles * 1.609

machine_two["specifications"]["depth_capacity_miles"] = depth_capacity_miles_km
print(machine_two)

#last_date = machine_two["last_maintenance_date"]

#yy, mm, dd = last_date.split("-")
#print(yy, mm, dd)

#last_date = f"{dd}/{mm}/{yy}"
#print(machine_two)

#machine_two["last_maintenance_date"] = last_date

#print(machine_two)

last_maintenance_date = machine_two["last_maintenance_date"]

 
last_maintenance_date_list = last_maintenance_date.split("-")  

last_maintenance_date_list_reversed = last_maintenance_date_list.reverse()
print(last_maintenance_date_list_reversed)

#last_maintenance_date = "/".join(last_maintenance_date_list_reversed)

#machine_two["last_maintenance_date"] = last_maintenance_date
...
#next = machine_two["next_maintenance_due"]

# yy, mm, dd = machine_two.split("-")
# next = f"{dd}/{mm}/{yy}"
# machine_two["next_maintenance_due"] = next
# print(machine_two)
...
dico_d_specifications = dico_droite["specifications"]
depth_capacity_miles = dico_d_specifications["depth_capacity_miles"]
depth_capacity_miles_kilometers = depth_capacity_miles * 1.609

dico_droite["specifications"]["depth_capacity_miles"] = depth_capacity_miles_kilometers
print(dico_droite)

dico_droite_last = dico_droite["last_maintenance_date"]
yy,mm,dd = dico_droite_last.split("-")
dico_droite["last_maintenance_date"] = f"{dd}/{mm}/{yy}"
print(dico_droite)

# dico_droite_next = dico_droite["next_maintenance_due"]
# yy,mm,dd = dico_droite_next.split("-")
# dico_droite["next_maintenance_due"] = f"{dd}/{mm}/{yy}"
# print(dico_droite)

dico_droite_next = dico_droite["next_maintenance_due"]
a = dico_droite_next.split("-")
print(a)

a_rev = a[::-1]
print(a_rev)
dico_droite["next_maintenance_due"] = "/".join(a_rev)
print(dico_droite["next_maintenance_due"])
print(dico_droite)
dico_droite["contact_information"] = dico_gauche["contact_information"]
print(dico_droite)

id_d = dico_droite["machine_id"]
